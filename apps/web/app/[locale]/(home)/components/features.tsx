    ...
    <div className="container mx-auto">
      <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex aspect-square h-full flex-col justify-between rounded-[var(--radius-md)] bg-muted p-6 lg:col-span-2 lg:aspect-auto">
          ...
          <div className="flex aspect-square flex-col justify-between rounded-[var(--radius-md)] bg-muted p-6">
            <User className="h-8 w-8 stroke-1" />
            <div className="flex flex-col">
              <h3 className="text-xl tracking-tight">
