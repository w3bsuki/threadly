...
const files = execSync(
  'find apps -name "*.tsx" -o -name "*.ts" | xargs grep -l "@repo/design-system/components/ui/" || true',
  { encoding: 'utf-8' }
)
  .trim()
  .split('\n')
...
const importMap = {
  ...
  '@repo/design-system/components/ui/lazy-image':
    '@repo/design-system/components',
  ...
  '@repo/design-system/components/ui/progress':
    '@repo/design-system/components',
  '@repo/design-system/components/ui/pull-to-refresh':
    '@repo/design-system/components',
  ...
  '@repo/design-system/components/ui/service-worker-registration':
    '@repo/design-system/components',
  '@repo/design-system/components/ui/micro-interactions':
    '@repo/design-system/components',
  '@repo/design-system/components/ui/animated':
    '@repo/design-system/components',
};
...
const remaining = execSync(
  'find apps -name "*.tsx" -o -name "*.ts" | xargs grep "@repo/design-system/components/ui/" || true',
  { encoding: 'utf-8' }
)
  .trim()
  .split('\n')
