...
async function seedTestProducts() {
  ...
  try {
    ...
    console.log(
      `Using seller: ${seller.firstName} ${seller.lastName} (${seller.id})`
    );
    ...
    const testProducts = [
      {
        ...
        description:
          'Classic 90s denim jacket in excellent condition. Light wash with minimal fading.',
        price: 89.99,
        brand: "Levi's",
        size: 'M',
        color: 'Blue',
      ...
      },
      {
        ...
        description:
          'Authentic leather handbag, barely used. Comes with dust bag and authenticity card.',
        price: 299.99,
        brand: 'Coach',
        size: 'One Size',
        color: 'Black',
